...
class TestBase(LiveServerTestCase):
    ...
    def setUp(self):
        """Setup the test driver and create the test users"""
...
class TestRegistration(TestBase):
    ...
    def test_registration(self):
        ...
        self.driver.find_element_by_id("username").send_keys(test_employee2_username)
        self.driver.find_element_by_id("first_name").send_keys(test_employee2_first_name)
        self.driver.find_element_by_id("last_name").send_keys(test_employee2_last_name)
        self.driver.find_element_by_id("password").send_keys(test_employee2_password)
        self.driver.find_element_by_id("confirm_password").send_keys(test_employee2_password)
        self.driver.find_element_by_id("submit").click()
        time.sleep(1)
        ...
        # assert succes message is shown
    ...
    def test_registration_invalid_email(self):
        ...
        error_message = self.driver.find_element_by_class_name("help-block").text
    ...
    def test_registration_confirm_password(self):
        ...
        self.driver.find_element_by_id("email").send_keys(test_employee2_email)
        self.driver.find_element_by_id("username").send_keys(test_employee2_username)
        self.driver.find_element_by_id("first_name").send_keys(test_employee1_first_name)
        self.driver.find_element_by_id("last_name").send_keys(test_employee2_last_name)
        self.driver.find_element_by_id("password").send_keys(test_employee2_password)
        self.driver.find_element_by_id("confirm_password").send_keys("passwords_wont_match")
        self.driver.find_element_by_id("submit").click()
        time.sleep(5)
...
class TestDepartments(CreateObjects, TestBase):
    ...
    def test_add_department(self):
        ...
        self.driver.find_element_by_id('description').send_keys(test_department2_description)
        self.driver.find_element_by_id("submit").click()
        time.sleep(2)
    ...
    def test_edit_department(self):
        ...
        self.driver.find_element_by_id("description").send_keys("Edited description")
        self.driver.find_element_by_id("submit").click()
        time.sleep(2)
        ...
        # Assert that department name and description have changed
...
class TestRoles(CreateObjects, TestBase):
    ...
    def test_add_role(self):
        ...
        self.driver.find_element_by_id("description").send_keys(test_role2_description)
        self.driver.find_element_by_id("submit").click()
        time.sleep(2)
    ...
    def test_add_existing_role(self):
        """
        Test that an admin user cannot add a role with a name that already exists
        """
        ...
        self.driver.find_element_by_id("description").send_keys(test_role1_description)
        self.driver.find_element_by_id("submit").click()
        time.sleep(2)
...
class TestEmployees(CreateObjects, TestBase):
    ...
    def test_reassign(self):
        ...
        department = Department(name=test_department2_name, description=test_department2_description)
